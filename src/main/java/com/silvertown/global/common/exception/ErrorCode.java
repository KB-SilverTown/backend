...
public enum ErrorCode {
    ...
    TRANSFER_CONFIRMATION_REQUIRED(HttpStatus.UNPROCESSABLE_ENTITY, "TRANSFER_CONFIRMATION_REQUIRED", "유효한 송금 승인 토큰이 필요합니다."),
    TRANSFER_CONFIRMATION_INVALID(HttpStatus.UNPROCESSABLE_ENTITY, "TRANSFER_CONFIRMATION_INVALID", "송금 승인 토큰이 올바르지 않습니다."),
    TRANSFER_CONFIRMATION_EXPIRED(HttpStatus.GONE, "TRANSFER_CONFIRMATION_EXPIRED", "송금 승인 토큰이 만료되었습니다. 최종 승인을 다시 진행해 주세요."),
